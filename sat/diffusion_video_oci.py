...
class SATVideoDiffusionEngine(nn.Module):
    def __init__(self, args, **kwargs):
        ...
        encoder_temporal_tiling_window = model_config.get("encoder_temporal_tiling_window", None)
        decoder_temporal_tiling_window = model_config.get("decoder_temporal_tiling_window", None)
        ...
        self.encoder_temporal_tiling_window = encoder_temporal_tiling_window
        self.decoder_temporal_tiling_window = decoder_temporal_tiling_window
            ...
            for n in range(n_rounds):
                ...
                if self.decoder_temporal_tiling_window:
                    ...
                    for i in range(z.shape[2]//window):
                        ...
                        window_out = self.first_stage_model.decode(
                            z[n * n_samples : (n + 1) * n_samples, :, start_frame:end_frame].contiguous(), 
                            clear_fake_cp_cache=(i + 1 == z.shape[2]//window),
                            **kwargs)

...
def main():
    ...
    print(f"Number of videos: {len(dic_list)}")
    ...
    # Count videos between 8 and 35 seconds
    videos_8_to_35 = sum(8 < d < 35 for d in durations)
    print(f"\nNumber of videos between 8 and 35 seconds: {videos_8_to_35}")
    print(f"Percentage of videos between 8 and 35 seconds: {videos_8_to_35 / len(durations) * 100:.2f}%")

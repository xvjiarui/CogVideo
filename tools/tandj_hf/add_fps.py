"""
python tools/tandj_hf/add_fps.py data/tandj_hf/videos data/tandj_hf/metadata/default.jsonl data/tandj_hf/metadata/default_stats.jsonl
"""
import argparse
import json
import os
...
def get_video_info_ffprobe(video_path):
    ...
    if not len(json.loads(result.stdout)['streams']):
        print(f"Error processing video {video_path}: {result.stderr}")

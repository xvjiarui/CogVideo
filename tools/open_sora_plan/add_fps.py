"""
Add fps and other video info to the jsonl file

Example:
python tools/open_sora_plan/add_fps.py data/open-sora-plan-v110/pixabay_v2 data/open-sora-plan-v110/metadata/pixabay_v2/video_pixabay_65f_601513.jsonl data/open-sora-plan-v110/metadata/pixabay_v2/video_pixabay_65f_601513_fps.jsonl
python tools/open_sora_plan/add_fps.py data/open-sora-plan-v110/pixabay_v2 data/open-sora-plan-v110/metadata/pixabay_v2/video_pixabay_513f_51483.jsonl data/open-sora-plan-v110/metadata/pixabay_v2/video_pixabay_513f_51483_fps.jsonl
"""
import argparse
import json
import os
...
def process_video(dic, video_folder):
    ...
    dic['width'] = width
    dic['height'] = height
    # make sure the caps is the last key
    dic['caps'] = dic.pop('caps')
